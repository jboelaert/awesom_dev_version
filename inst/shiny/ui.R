shinyUI(
  navbarPage(
    ...
    theme = bslib::bs_theme_update(bslib::bs_theme(bootswatch = "united"),
                                   primary = "#ff9733ff",
                                   secondary = "#ffc46dff",
      ...
      fluidRow(column(4, wellPanel( 
        ...
        conditionalPanel("input.trainAdvanced", 
                         ...
                         fluidRow(column(4, p("maxNA.fraction")), 
                                  column(6, numericInput("trainMaxNA", NULL, .25, 0, 1, .25)), 
        ...
        column(8, 
               fluidRow(column(5,
                        ...
                        column(7, 
                               fluidRow(column(3, h5("Weights:")),
                                        column(4, actionButton("weightsToOne", "Weights to 1")),
                                        column(5, actionButton("weightsToComp", "Compensate levels"))),
             ...
             fluidRow(column(4, 
                               ...
                               conditionalPanel("input.plotAdvanced", 
                                                ...
                                                conditionalPanel('input.graphType == "Cloud"', 
                                                                 fluidRow(
                                                                   ...
                                                                   column(7, selectInput("plotCloudType", NULL, 
                                                                                         c("Cell-wise PCA" = "cellPCA",
                                                                                           "Cell-centered kPCA" = "kPCA", 
                                                                                           "Cell-centered PCA" = "PCA",
                                                                                           "Prototype Proximity" = "proximity", 
                                                                                           "Random" = "random"))))),
                                                conditionalPanel('input.graphType == "Cloud" & input.plotCloudType == "random"', 
                                                                 fluidRow(
                                                ...
                                                conditionalPanel(paste0('input.graphType == "Circular" | ', 
                                                                 ...
                                                                 fluidRow(column(4, p("Legend")),
                                                                          ...
                                                                          column(5, selectInput("legendPos", NULL, 
                                                                                                c("Beside" = "beside", 
                                                                                                  "Below" = "below", 
                                                                                                  "None" = "none"), 
                                                                                                "beside"))))
                             ...
                             fluidRow(column(3, numericInput('kohSuperclass', NULL, 2, min= 1)), 
                                      column(5, selectInput('sup_clust_method', NULL, 
                                                            c("hierarchical", "pam"))),
                                      column(4, conditionalPanel('input.sup_clust_method == "hierarchical"', 
                      ...
                      column(8, 
                             ...
                             conditionalPanel('input.graphType != "Silhouette" & input.graphType != "Dendrogram" & input.graphType != "Screeplot" & input.graphType != "SmoothDist"', 
                                              ...
                                              conditionalPanel('input.graphType != "Radar" & input.graphType != "Line" & input.graphType != "Heat" & input.graphType != "Hitmap"',
