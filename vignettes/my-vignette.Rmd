...
__aweSOM__ is an R package offering a set of comprehensive tools to explore and analyze datasets with Self-Organizing Maps (also known as [https://en.wikipedia.org/wiki/Self-organizing_map](Kohonen maps)), an artificial neural network created by [https://en.wikipedia.org/wiki/Teuvo_Kohonen](Teuvo Kohonen) in the 1980s. 
